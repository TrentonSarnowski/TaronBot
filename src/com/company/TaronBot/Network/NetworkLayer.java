...
public class NetworkLayer implements Serializable {
	...
	/**
	 * 
	 * @return nonLinearFunction that this layer uses as the function for each sum calculation.
	 */
	...
	/**
	 * 
	 * @param previousLayerDimensions
	 *            int[4] expected input dimensions
	 * @param outputLayerDimensions
	 *            int[4] expected output dimensions
	 * @param function
	 *            non linear function that can be used as the sum function.
	 */
	 ...
	 * 
	 * @param weights
	 *            double [][][][] that holds the weighting numbers to be applied to the inputs
	 * @param input
	 *            double[][][][] that holds the input values from the previous layer
	 ...
	 * 
	 * @param rand
	 *            Random random number generator used to randomize the network.
	 */
	...
	/**
	 * returns a randomized network layer based on the current layer where the randomization is based on a give percentage
	 * 
	 * @param rand
	 *            Random random number generator for the mutation randomization
	 * @param changePrecentage
	 *            Double 0.0-1.0 that represents the percentage of weights to change
