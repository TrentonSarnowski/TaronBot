...
public class RunGames {
	...
	public enum victoryType {
		...
		PAGE_WEIGHTED_WIN_WEIGHTED, PAGE_WEIGHTED_WIN_ROAD_ONLY, PAGE_WEIGHTED_WIN_LOSS_WEIGHTED, PAGE_WEIGHTED_WIN_LOSS_NO_WEIGHT, // May not order properly
	...
	/**
	 * Plays game in a pool based off of a life value system Randomly picks two networks, The looser looses some amount of life, And thw inner gains some amount of life If a network reaches zero life it is replaced with a newly generated network based off of group generation
	 * 
	 * @param networks
	 * @param lifeCount
	 * @param games
	...
	public List<TakNetwork> GetSortedNetworks(victoryType victoryType) {
		...
		case WIN_WEIGHTED:
			...
			break;
		/**
		 * case PAGE_WEIGHTED_WIN_LOSS_NO_WEIGHT: returnValue = OrderedTakNetwork.PageRankOrdering(networks, winLossNoWeightPage); break; case PAGE_WEIGHTED_WIN_LOSS_WEIGHTED: returnValue = OrderedTakNetwork.PageRankOrdering(networks, winLossWeightedPage);
		 * 
		 * break; case PAGE_WEIGHTED_WIN_NO_WEIGHT: returnValue = OrderedTakNetwork.PageRankOrdering(networks, winNoWeightPage); break; case PAGE_WEIGHTED_WIN_ONE_TWO_WEIGHT: returnValue = OrderedTakNetwork.PageRankOrdering(networks, winOneTwoWeightPage);
		 * 
		 * break; case PAGE_WEIGHTED_WIN_ROAD_ONLY: returnValue = OrderedTakNetwork.PageRankOrdering(networks, winRoadOnlyPage); break; case PAGE_WEIGHTED_WIN_WEIGHTED: returnValue = OrderedTakNetwork.PageRankOrdering(networks, winWeightedPage); break; case LEGAL_MOVE_DEPTH: return networks;
		 */
		default:
			return null;
		}
